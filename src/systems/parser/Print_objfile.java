...
public class Print_objfile {
   ...
   void print(){
            try {
                ...
                writer1 = new PrintWriter("D:\\Engineering\\CCE\\systems programming\\Systems Parser Final\\Systems Parser Final\\Systems Parser Final\\src\\systems\\parser\\Objfile.txt");
                writer1.print("");
                writer1.close();
                try (FileWriter writer = new FileWriter("D:\\Engineering\\CCE\\systems programming\\Systems Parser Final\\Systems Parser Final\\Systems Parser Final\\src\\systems\\parser\\Objfile.txt", true)){
